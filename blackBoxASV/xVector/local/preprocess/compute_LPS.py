...
if __name__ == "__main__":
    ...
    wavfile_dir_train = os.path.join(
        args.in_dir, args.access_type, f"ASVspoof2019_{args.access_type}_train", "flac"
    )
    wavfile_dir_dev = os.path.join(
        args.in_dir, args.access_type, f"ASVspoof2019_{args.access_type}_dev", "flac"
    )
    wavfile_dir_eval = os.path.join(
        args.in_dir, args.access_type, f"ASVspoof2019_{args.access_type}_eval", "flac"
    )
