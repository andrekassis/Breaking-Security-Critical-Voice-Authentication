...
def main(args):
    ...
    # print(1+args.sigma)
    keys, mat_list = extract_adv_mat_frm_grads(
    ...
    for key, mat in zip(keys, mat_list):
        ...
        print("reverting.")
        adv_wav = revert_power_db_to_wav(
            spec, mat, n_fft=128, hop_length=64, win_length=128, window="blackman"
        )
        print("saving.")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ori_feats", default="data/voxceleb1_test/feats.scp", type=str
    )
