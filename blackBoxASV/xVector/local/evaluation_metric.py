...
def compute_eer(trials, scores):
    ...
    trial_ids = list(trial_scores.keys())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--trials", default="data/voxceleb1_test/trials_adv", type=str)
    ...
    if args.threshold == -99999:
        ...
        print(
            "The FAR is %f, FRR is %f, under the threshold of %f."
            % (FAR, FRR, args.threshold)
        )
