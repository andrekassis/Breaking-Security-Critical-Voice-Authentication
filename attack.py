...
def init(config, device):
    ...
    ###test
    reduce_conf = {'stationary': True, 'win': 'hamming_window', 'n_fft': 1024, 'hop_length': 256, 'win_length': 1024, 'device': device, 'freq_mask_smooth_hz': 500, 'time_mask_smooth_ms': 50, 'padding':0}
    ###test
